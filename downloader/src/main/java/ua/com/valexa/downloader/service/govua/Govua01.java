...
@Service("govua01")
public class Govua01 implements Downloadable {

    private static final Logger log = LoggerFactory.getLogger(Govua01.class);
    ...
    public Govua01(RabbitTemplate rabbitTemplate, String getQueueCpmsStepUpdate) {
