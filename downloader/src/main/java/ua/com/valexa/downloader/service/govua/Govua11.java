...
@Service("govua11")
public class Govua11 implements Downloadable {

    private static final Logger log = LoggerFactory.getLogger(Govua11.class);
    ...
    public Govua11(RabbitTemplate rabbitTemplate, String getQueueCpmsStepUpdate) {
