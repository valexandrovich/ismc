...
@Service("govua08")
public class Govua08 implements Downloadable {

    private static final Logger log = LoggerFactory.getLogger(Govua08.class);
    ...
    public Govua08(RabbitTemplate rabbitTemplate, String getQueueCpmsStepUpdate) {
