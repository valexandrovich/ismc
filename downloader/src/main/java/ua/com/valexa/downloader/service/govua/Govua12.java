...
@Service("govua12")
public class Govua12 implements Downloadable {

    private static final Logger log = LoggerFactory.getLogger(Govua12.class);
    ...
    public Govua12(RabbitTemplate rabbitTemplate, String getQueueCpmsStepUpdate) {
