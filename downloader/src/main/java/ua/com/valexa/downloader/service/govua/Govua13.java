...
@Service("govua13")
public class Govua13 implements Downloadable {

    private static final Logger log = LoggerFactory.getLogger(Govua13.class);
    ...
    public Govua13(RabbitTemplate rabbitTemplate, String getQueueCpmsStepUpdate) {
