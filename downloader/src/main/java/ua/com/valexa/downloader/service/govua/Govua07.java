...
@Service("govua07")
public class Govua07 implements Downloadable {

    private static final Logger log = LoggerFactory.getLogger(Govua07.class);
    ...
    public Govua07(RabbitTemplate rabbitTemplate, String getQueueCpmsStepUpdate) {
