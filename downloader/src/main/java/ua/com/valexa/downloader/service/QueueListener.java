...
//    Downloadable downloadable;
    ...
    final String getQueueDownloaderStepRequest;

    public QueueListener(ApplicationContext applicationContext, String getQueueCpmsStepUpdate, Tracing tracing, ObjectMapper objectMapper, RabbitTemplate rabbitTemplate, String getQueueDownloaderStepRequest) {
//        this.downloadable = downloadable;
        ...
        this.getQueueDownloaderStepRequest = getQueueDownloaderStepRequest;
    }

    @RabbitListener(queues = "#{getQueueDownloaderStepRequest}", errorHandler = "queueListenerErrorHandler")
    public void recieveStepRequestMessage(Message message) {
        ...
        try (Tracer.SpanInScope ws = tracing.tracer().withSpanInScope(span)) {
            ...
            Downloadable downloadable = applicationContext.getBean(stepRequestDto.getWorker(), Downloadable.class);
            CompletableFuture<StepUpdateDto> cfuture = CompletableFuture.supplyAsync(() -> downloadable.handleStepRequest(stepRequestDto), executorService);
