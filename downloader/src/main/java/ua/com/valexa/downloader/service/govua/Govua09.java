...
@Service("govua09")
public class Govua09 implements Downloadable {

    private static final Logger log = LoggerFactory.getLogger(Govua09.class);
    ...
    public Govua09(RabbitTemplate rabbitTemplate, String getQueueCpmsStepUpdate) {
