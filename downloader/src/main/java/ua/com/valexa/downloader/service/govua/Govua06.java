...
@Service("govua06")
public class Govua06 implements Downloadable {

    private static final Logger log = LoggerFactory.getLogger(Govua06.class);
    ...
    public Govua06(RabbitTemplate rabbitTemplate, String getQueueCpmsStepUpdate) {
