...
@Service("uploader_le")
public class UploadLeImporter implements Importable {

    private static final Logger log = LoggerFactory.getLogger(UploadLeImporter.class);
