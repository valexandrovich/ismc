...
import ua.com.valexa.importer.repository.Govua08Repository;
...
public class Govua08Service {
    ...
    @Autowired
    Govua08Repository govua08Repository;

    @Autowired
    EntityManager entityManager;

//    public List<Govua08> findByNameLike(String lastName, String firstName, String patronymicName) {
//        StringBuilder jpql = new StringBuilder("SELECT r FROM Govua08 r WHERE 1=1");
//
...
//        }
//
//        TypedQuery<Govua08> query = entityManager.createQuery(jpql.toString(), Govua08.class);
//
//        if (lastName != null && !lastName.trim().isEmpty()) {
...
//    }
    ...
    public List<Govua08> findByNameEqual(String lastName, String firstName, String patronymicName) {
        StringBuilder jpql = new StringBuilder("SELECT r FROM Govua08 r WHERE 1=1");
        ...
        if (firstName != null && !firstName.trim().isEmpty()) {
            jpql.append(" AND (r.firstNameUa = :firstName OR r.firstNameEn = :firstName OR r.firstNameRu = :firstName)");
        }
        if (patronymicName != null && !patronymicName.trim().isEmpty()) {
