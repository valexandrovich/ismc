...
<template>
  ...
  <div   class="flex flex-col   w-[480px]">
    <div class="flex flex-row justify-end">
      ...
      <span class="bg-sky-700 z-80 uppercase px-3 py-0.5 ml-[-20px]  text-gray-50 rounded-t-2xl">Виконавче провадження</span>
    </div>
    ...
    <div class="relative h-full bg-white rounded-2xl rounded-tr-none p-3 shadow-xl">
      <table class="pb" :class="isDisabled ? 'text-gray-400':''">
        ...
        <tr><td colspan="2"  class="text-gray-400 font-semibold text-lg"><span>Боржник:</span></td></tr>
            ...
            <tr><td colspan="2"  class="border-t-4 border-gray-200 border-dotted text-gray-400 font-semibold text-lg"><span>Кредитор:</span></td></tr>
